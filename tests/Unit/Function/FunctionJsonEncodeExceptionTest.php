...
/**
 * Class FunctionJsonEncodeExceptionTest
 *
 * @author Björn Hempel <bjoern@hempel.li>
 * @version 0.1.0 (2022-12-30)
 * @since 0.1.0 (2022-12-30) First version.
 * @link FunctionJsonEncodeException
 */
final class FunctionJsonEncodeExceptionTest extends TestCase
{
    /**
     * Test wrapper.
     *
    ...
    public function test(): void
    {
        ...
        } catch (FunctionJsonEncodeException $exception) {
            $expectedNonVerbose = FunctionJsonEncodeException::TEXT_PLACEHOLDER;
